...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('jenismasalah.store') }}" method="POST">
                {{ csrf_field() }}
                <div class="box-body">
                   ...
                   <div class="form-group {{ $errors->has('kode_jenis_masalah') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="kode_jenis_masalah" class="form-control" id="exampleInputEmail1" placeholder="">
                    ...
                    <div class="form-group {{ $errors->has('keterangan_jenis_masalah') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="keterangan_jenis_masalah" class="form-control" id="exampleInputPassword1" placeholder="">
