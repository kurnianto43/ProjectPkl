...
<div class="row">
        <div class="col-md-8 col-md-offset-2">
           <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('tagihan.update', $tagihan) }}" method="POST">
                {{ csrf_field() }}
                @method('PATCH')
                ...
                <div class="box-body">
                    <div class="form-group {{ $errors->has('nomor_dokumen') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="nomor_dokumen" value="{{ $tagihan -> nomor_dokumen }}" class="form-control" id="exampleInputEmail1" placeholder="">
                    ...
                    <div class="form-group {{ $errors->has('periode_perbaikan') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="periode_tagihan" value="{{ $tagihan -> periode_tagihan }}" class="form-control" id="exampleInputEmail1" placeholder="">
