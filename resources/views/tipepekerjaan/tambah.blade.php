...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form role="form" action="{{ route('tipepekerjaan.store') }}" method="POST">
                {{ csrf_field() }}
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('kode_tipe_pekerjaan') ? ' has-error' : '' }}">
                        ...
                        <input type="text" name="kode_tipe_pekerjaan" class="form-control" id="exampleInputEmail1" placeholder="">
                    ...
                    <div class="form-group {{ $errors->has('keterangan_tipe_pekerjaan') ? ' has-error' : '' }}">
                        ...
                        <textarea name="keterangan_tipe_pekerjaan" id="" cols="30" rows="2" class="form-control"></textarea>
                    ...
                    <div class="form-group {{ $errors->has('tarif') ? ' has-error' : '' }}">
                        ...
                        <input type="number" name="tarif" class="form-control" id="exampleInputPassword1" placeholder="">
                            @if ($errors->has('tarif'))      
